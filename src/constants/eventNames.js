...
export const EVENT_TARGET_PAGE_VIEWED = 'Target Page Viewed';
...
// Target Page - Target Toggle Events
export const EVENT_TARGET_PAGE_TOGGLE_DAILY = 'Target Page Toggle - Daily';
export const EVENT_TARGET_PAGE_TOGGLE_WEEKLY = 'Target Page Toggle - Weekly';
...
export default {
  ...
  EVENT_TARGET_PAGE_VIEWED,
  EVENT_EARNINGS_PAGE_VIEWED,
  EVENT_MORE_PAGE_VIEWED,
  ...
  // Target Page
  EVENT_TARGET_PAGE_TOGGLE_DAILY,
  EVENT_TARGET_PAGE_TOGGLE_WEEKLY,
